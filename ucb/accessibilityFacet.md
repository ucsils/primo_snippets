...
```
## Normalization Rules for Search & Facet

### Braille materials 

```
rule "Primo VE Marc - Lsr##"
#braille text and maps - control fields
	when
		(MARC.control."LDR"(6-7) matches "a|c|d|i|j|p|t" AND
		MARC.control."008"(23-24) equals "f") OR
		(MARC.control."LDR"(6-7) matches "e|f|g|k|o|r" AND
		MARC.control."008"(29-30) equals "f")
	then
		create pnx."search"."lsr##"  with "Braille"
end

rule "Primo VE Marc - Lsr##/2"
# braille marc fields - all resource types
	when
		(MARC is "341"."e" AND
		MARC."341"."e" match "braille|Braille") OR
		(MARC is "546"."a" AND
